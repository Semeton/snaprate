  ...
  const fetchRewardsData = async () => {
    try {
      ...
      if (statsResponse.ok) {
        ...
        console.log("Rewards page received stats:", statsData);
              ...
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-yellow-800 mb-4">
                    You need at least ₦{stats?.minimumRedemption || 5000} to
                    redeem rewards.
                  </p>
                  <div className="space-y-2 text-sm text-yellow-700">
                    <p>Current balance: ₦{stats?.totalRewards || 0}</p>
                    <p>
                      Keep reviewing businesses and referring friends to earn
                      more!
                    </p>
                  </div>
                </div>
            ...
            <CardContent>
              {redemptions.length > 0 ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>
                    No redemptions yet. Redeem your rewards to see them here!
                  </p>
                </div>
              )}
            </CardContent>
