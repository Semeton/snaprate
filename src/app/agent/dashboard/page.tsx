...
export default function AgentDashboardPage() {
  ...
  const [onboardedBusinesses, setOnboardedBusinesses] = useState<OnboardedBusiness[]>([]);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">You need to create an agent profile to access this dashboard.</p>
          <Button asChild>
  ...
  if (!agentProfile.isApproved) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Profile Pending Approval</h1>
          <p className="text-gray-600 mb-4">Your agent profile is currently under review. You'll be notified once it's approved.</p>
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 dark:text-gray-400">Business Onboarding Agent Dashboard</p>
              <div className="flex items-center space-x-4 mt-2 text-sm text-gray-500 dark:text-gray-400">
                <span className="flex items-center space-x-1">
                  <Building2 className="h-4 w-4" />
                  <span>{stats?.totalBusinessesOnboarded} businesses onboarded</span>
                </span>
                <span className="flex items-center space-x-1">
                  <Award className="h-4 w-4" />
                  <span>{formatCurrency(stats?.totalEarnings || 0)} total earnings</span>
                </span>
                <span className="flex items-center space-x-1">
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{stats.totalBusinessesOnboarded}</div>
            ...
            <Card className="mt-6">
              ...
              <CardContent className="space-y-3">
                <div className="text-sm">
                  <div className="font-medium">Bank: {agentProfile.bankName}</div>
                  <div className="text-gray-600">Account: {agentProfile.accountNumber}</div>
                  <div className="text-gray-600">Name: {agentProfile.accountName}</div>
                </div>
                <Button className="w-full" variant="outline">
                  Update Bank Details
                </Button>
              ...
              <TabsContent value="overview" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Latest business onboarding activities</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          <p className="font-medium">ABC Restaurant verified successfully</p>
                      ...
                      <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          <p className="font-medium">New business "Tech Solutions Ltd" onboarded</p>
                      ...
                      <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                        ...
                        <div className="flex-1">
                          <p className="font-medium">Commission earned: ₦5,000 from Fashion Boutique</p>
              ...
              <TabsContent value="businesses" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Manage all businesses you've onboarded</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                        ...
                        <div key={business.id} className="flex items-center justify-between p-4 border rounded-lg">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-600 mt-1">
                              ...
                              <span className="ml-4">Owner: {business.owner.name}</span>
                              <span className="ml-4">Category: {business.category}</span>
                            </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-500 text-center py-8">
                      Earnings and commission tracking interface will be displayed here
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
